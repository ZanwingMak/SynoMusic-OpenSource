...
- 英語表示のログイン画面で、保存済み NAS プロファイルの名前・ステータスバッジ・URL が崩れないよう調整しました。
- 設定、サーバー編集、キュー操作、プレイリスト、読み込み/再試行状態、言語/音質選択まわりの未翻訳文言を補完しました。
- アクセントカラー反映、QuickConnect 互換性、シャッフル中の選曲、アルバムグリッド、読み込み通知、プレーヤーメニューとキュー編集操作を修正しました。
